...
describe('UserDB Interface Compliance', () => {
  ...
  describe('Card Operations', () => {
    it('should handle card record storage', async () => {
      ...
      const cardHistory = await rawCouch.getCardHistory(userContext.testUser.username, cardRecord.cardId);
  ...
  describe('Review Management', () => {
    ...
    it('should comply with removeScheduledCardReview interface', async () => {
      ...
      // Remove using interface-compliant call (username, reviewId)
      await userContext.user.removeScheduledCardReview(
        userContext.testUser.username, 
        reviewToRemove._id
      );
  ...
  describe('Error Handling', () => {
    ...
    it('should handle invalid review removal gracefully', async () => {
      await expect(
        userContext.user.removeScheduledCardReview(
          userContext.testUser.username, 
          'non-existent-review-12345'
        )
      ).rejects.toThrow();
    });
