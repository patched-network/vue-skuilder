...
This is the default implementation of the HERO banner for vitepress
generated sites. It was the basis for modification in adjacent file ./CustomVPHero.vue, which is
loaded according to config defined in docs/.vitepress/config.mts
